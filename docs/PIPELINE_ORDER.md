...
│
├─ m01_vision_ejecutiva.py hasta m13_eficiencia_procesos.py
│  └─ Genera: vistas y funciones RPC por módulo
...
│  └─ Depende de: m01-m13 (todas las vistas deben existir)
│
...
│  └─ Depende de: m01-m13 (vistas deben existir)
│
└─ 92_generate_lineage.py
   └─ Genera: docs/02-data-governance/04_data_lineage.md ✅
   └─ Depende de: PIPELINE completo y metadatos
...
│  └─ Requiere: Blueprint + Data Dictionary + Lineage generados + Pipeline completo
...
└─ Script 92: generate_lineage.py → 04_data_lineage.md
```
...
| m01-m13 | `m01_*.py` a `m13_*.py` | Data marts modulares | MVs + vistas + RPCs por módulo |
...
| 92 | `92_generate_lineage.py` | Linaje de datos | `04_data_lineage.md` ✅ timestamp ISO 8601 |
...
| `04_data_lineage.md` | Script 92 | ✅ ISO 8601 UTC |
...
| Script 04 | Python | Script 03 | Scripts m01-m13 |
| Scripts m01-m13 | Python | Script 04 | Scripts 90, 91, 92 |
| Script 90 | Python | Scripts m01-m13 | Documentación |
| Script 91 | Python | Scripts m01-m13 | Documentación |
| Script 92 | Python | Scripts m01-m13 | Documentación |
...
1. **Orden obligatorio del pipeline:** 01 → 02 → 03 → 04 → m01-m13 → 90 → 91 → 92
...
6. **Los modulos son independientes:** puedes agregar más módulos sin afectar el resto.
7. **90, 91 y 92 son post-pipeline:** dependen de que todas las vistas existan.

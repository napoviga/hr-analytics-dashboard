    ...
    <div className="flex flex-col space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gray-900 border border-gray-700 rounded-lg p-6 shadow-xl flex items-center justify-between">
          <div>
            <p className="text-gray-400 text-sm font-semibold uppercase tracking-wider mb-1">Promedio Tarifa Diaria</p>
        ...
        <div className="bg-gray-900 border border-gray-700 rounded-lg p-6 shadow-xl flex items-center justify-between">
          <div>
            <p className="text-gray-400 text-sm font-semibold uppercase tracking-wider mb-1">Edad Promedio</p>
            <h3 className="text-4xl font-extrabold text-blue-400">{avgAge} <span className="text-2xl text-gray-500">años</span></h3>
          </div>
